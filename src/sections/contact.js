    ...
    return (
        <section id="contact" className="contact container section mx-auto">
            <div className="contact__content">
                <h2 className="section__title" data-sal="fade" data-sal-easing="ease-in-cubic">Contato</h2>
                <p className="mb-4 w-full md:w-3/4" data-sal="slide-up" data-sal-easing="ease-in-cubic">Entre em contato com o DAFIS. Mande sua dúvida ou requisição!</p>
                <form id="contact_form" className="w-full md:w-3/4" noValidate data-sal="slide-up" data-sal-easing="ease-in-cubic" data-sal-delay="100">
                    ...
                    <div className="input-group mb-2">
                        <label htmlFor="email">Endereço de e-mail (não enviamos spam!)</label>
